...
const FALLBACK_MENU: MenuItem[] = [
  ...
  { id: 'spv',          menu_label: 'Business Registry',  path: '/spv',           source_sheet_name: '—', icon_name: 'building', enabled: true, allowed_levels: ['LEVEL_1','LEVEL_2','LEVEL_3'], admin_only: false, hidden_but_queryable: false, sort_order: 4 },
